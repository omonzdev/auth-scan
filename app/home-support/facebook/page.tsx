  ...
  return (
    <div className="flex flex-col gap-3 justify-start items-center h-screen bg-gray-100 w-full p-10">
      <div className="flex flex-col items-center justify-center p-4 bg-white shadow-sm w-full md:max-w-3/12">
        ...
        <hr className="border w-full border-slate-200 my-2" />
        <button className="bg-green-600 text-white w-65 py-2 text-md font-semibold my-4 cursor-pointer rounded hover:bg-green-700 transition duration-200">
          Create new account
        </button>
      </div>
